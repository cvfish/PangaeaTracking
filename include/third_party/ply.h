	...
	)
{
	...
	*version = plyfile->version;
	...
	//	fpos_t position;
	//	fgetpos(fp, &position);
	//	plyfile->fp = freopen(filename, "rb", fp);
	//	fsetpos(plyfile->fp, &position);
	//}
...
inline void setup_other_props(PlyFile *plyfile, PlyElement *elem)
{
	int i;
	PlyProperty *prop;
	int size = 0;
...
inline void add_element(PlyFile *plyfile, char **words, int nwords)
{
	PlyElement *elem;
...
namespace ply{
	...
	struct VertexColorAlpha : public VertexColor {
		unsigned char a;
	};
	...
	struct VertexNormalColorAlpha : public VertexNormalColor {
		unsigned char a;
	};
	...
	static PlyProperty vc_props[] = { /* list of property information for a vertex with uchar rgb */
		...
		{ "y", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexColor, y), 0, 0, 0, 0 },
		{ "z", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexColor, z), 0, 0, 0, 0 },
		{ "red", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColor, r), 0, 0, 0, 0 },
		{ "green", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColor, g), 0, 0, 0, 0 },
		{ "blue", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColor, b), 0, 0, 0, 0 }
	};

	static PlyProperty vca_props[] = { /* list of property information for a vertex with uchar rgba */
		{ "x", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexColorAlpha, x), 0, 0, 0, 0 },
		{ "y", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexColorAlpha, y), 0, 0, 0, 0 },
		{ "z", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexColorAlpha, z), 0, 0, 0, 0 },
		{ "red", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColorAlpha, r), 0, 0, 0, 0 },
		{ "green", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColorAlpha, g), 0, 0, 0, 0 },
		{ "blue", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColorAlpha, b), 0, 0, 0, 0 },
		{ "alpha", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexColorAlpha, a), 0, 0, 0, 0 },
	};

	static PlyProperty vnc_props[] = { /* list of property information for a vertex with normals and uchar rgb */
		{ "x", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColor, x), 0, 0, 0, 0 },
		{ "y", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColor, y), 0, 0, 0, 0 },
		{ "z", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColor, z), 0, 0, 0, 0 },
		{ "nx", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColor, nx), 0, 0, 0, 0 },
		{ "ny", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColor, ny), 0, 0, 0, 0 },
		{ "nz", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColor, nz), 0, 0, 0, 0 },
		{ "red", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexNormalColor, r), 0, 0, 0, 0 },
		{ "green", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexNormalColor, g), 0, 0, 0, 0 },
		{ "blue", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexNormalColor, b), 0, 0, 0, 0 }
	};

	static PlyProperty vnca_props[] = { /* list of property information for a vertex with normals and uchar rgba */
		{ "x", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColorAlpha, x), 0, 0, 0, 0 },
		{ "y", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColorAlpha, y), 0, 0, 0, 0 },
		{ "z", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColorAlpha, z), 0, 0, 0, 0 },
		{ "nx", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColorAlpha, nx), 0, 0, 0, 0 },
		{ "ny", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColorAlpha, ny), 0, 0, 0, 0 },
		{ "nz", PLY_FLOAT, PLY_FLOAT, offsetof(ply::VertexNormalColorAlpha, nz), 0, 0, 0, 0 },
		{ "red", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexNormalColorAlpha, r), 0, 0, 0, 0 },
		{ "green", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexNormalColorAlpha, g), 0, 0, 0, 0 },
		{ "blue", PLY_UCHAR, PLY_UCHAR, offsetof(ply::VertexNormalColorAlpha, b), 0, 0, 0, 0 },
	...
	static PlyProperty face_props[] = { /* list of property information for a vertex */
		{ "vertex_indices", PLY_INT, PLY_INT, offsetof(ply::Face, verts),
	...
	inline PlyProperty* get_vertex_property(int _vertex_type, int _prop_idx)
	{
		PlyProperty* prop;
		...
		case PLY_VERTEX_NORMAL_RGB:
			prop = &ply::vnc_props[_prop_idx];
			break;
		case PLY_VERTEX_RGBA:
			prop = &ply::vca_props[_prop_idx];
			break;
